...
mknod = [
    ...
    'echo as9736_64d_cpld_psu 0x60 > /sys/bus/i2c/devices/i2c-36/new_device',
    'echo as9736_64d_cpld_psu 0x60 > /sys/bus/i2c/devices/i2c-44/new_device',
    ...
    'echo as9736_64d_psu1 0x50 > /sys/bus/i2c/devices/i2c-33/new_device',

    # PSU-2
    'echo delta_dps2400 0x59 > /sys/bus/i2c/devices/i2c-41/new_device',
    'echo as9736_64d_psu2 0x51 > /sys/bus/i2c/devices/i2c-41/new_device',
