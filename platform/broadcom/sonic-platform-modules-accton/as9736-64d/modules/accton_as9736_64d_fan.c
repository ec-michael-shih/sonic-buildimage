...
static const u8 fan_reg[] = {
    ...
    0x32,       /* fan 2 PWM */
    0x33,       /* fan 1 PWM */
    0x40,       /* fan 4 front tach speed(rpm) */
    0x41,       /* fan 3 front tach speed(rpm) */
    0x42,       /* fan 2 front tach speed(rpm) */
    0x43,       /* fan 1 front tach speed(rpm) */
    0x50,       /* fan 4 rear tach speed(rpm) */
    0x51,       /* fan 3 rear tach speed(rpm) */
    0x52,       /* fan 2 rear tach speed(rpm) */
    0x53,       /* fan 1 rear tach speed(rpm) */
...
{
    u8 ret = 1;
    int front_fan_index = 14 - id;       /*fan1=14, fan2=13, fan3=12, fan4=11*/
    int rear_fan_index  = front_fan_index  + 4; /*fan1=18, fan2=17, fan3=16, fan4=15*/
